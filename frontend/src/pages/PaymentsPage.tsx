...
import { Add, Search, Edit, Delete, Launch, Home } from '@mui/icons-material'
        ...
        <Grid item xs={12} md={4}>
          <Paper sx={{ p: 3, mb: 2 }}>
            ...
            <Typography variant="body2" sx={{ mb: 1 }}>
              📊 Total de items: <strong>{totalPayments}</strong>
            </Typography>
            <Typography variant="body2" sx={{ mb: 1 }}>
              🔗 Con URL: <strong>{paymentsWithUrl}</strong>
            </Typography>
            <Typography variant="body2" sx={{ mb: 1 }}>
              📝 Sin URL: <strong>{paymentsWithoutUrl}</strong>
            </Typography>
            <Typography variant="body2">
              📁 Categorías: <strong>{categories.length}</strong>
            </Typography>
          </Paper>
